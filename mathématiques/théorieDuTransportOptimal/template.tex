...
2) Equivalent à l'exemple du cours.\\

3) Exercice non traité dans le cadre du cours.
}
\exr{
...
$$
et en déduire (1) 5. En déduire que $\mathcal{T}_c\left(\mathbb{1}_{[0,1]}, \mathbb{1}_{[1,2]}\right)=1$.
}
